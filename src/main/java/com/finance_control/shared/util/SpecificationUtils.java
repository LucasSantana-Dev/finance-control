...
public class SpecificationUtils {
     ...
     * 
     * @param fieldName the name of the field to check
     * @param isNull    true if field should be null, false if field should not be
     *                  null
     * @param <T>       the entity type
     * @return a specification for null checking
     */
    public static <T> Specification<T> isNull(String fieldName, boolean isNull) {
        return (root, query, criteriaBuilder) -> isNull ? criteriaBuilder.isNull(root.get(fieldName))
