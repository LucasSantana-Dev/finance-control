...
public class FinancialGoalController extends BaseController<FinancialGoal, Long, FinancialGoalDTO> {
    ...
    @GetMapping("/active")
    @Operation(summary = "Get active goals", description = "Retrieve all active financial goals for the current user.")
    ...
    @Operation(summary = "Get completed goals", description = "Retrieve all completed financial goals for the current user.")
    ...
    @Operation(summary = "Update goal progress", description = "Add an amount to the current progress of a goal.")
    ...
    @Operation(summary = "Mark goal as completed", description = "Mark a financial goal as completed.")
    ...
    @Operation(summary = "Reactivate goal", description = "Reactivate a previously completed goal.")
