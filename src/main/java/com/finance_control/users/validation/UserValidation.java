...
public final class UserValidation {
    ...
    public static void validatePassword(String password) {
        ...
        if (!password.matches("^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d).+$")) {
            throw new IllegalArgumentException("Password must contain at least one lowercase letter, one uppercase letter, and one digit");
        }
    }
     ...
     */
    public static void validateEmailUnique(String email, java.util.function.Function<String, Boolean> emailExistsFunction) {
        validateEmail(email);
        
        if (emailExistsFunction.apply(email)) {
    ...
    public static void validateEmailUniqueForUpdate(String email, String currentEmail, 
                                                   java.util.function.Function<String, Boolean> emailExistsFunction) {
